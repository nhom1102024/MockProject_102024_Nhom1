...
import "./chunk-7FQAOU4E.js";
import {
  createSvgIcon
} from "./chunk-DB3A626Z.js";
import "./chunk-OUZARFZ5.js";
import {
  styled_default
...
var GitHub_default = createSvgIcon((0, import_jsx_runtime2.jsx)("path", {
...
var Password_default = createSvgIcon((0, import_jsx_runtime3.jsx)("path", {
...
function SignInPage(props) {
  ...
  const docs = React21.useContext(DocsContext);
  ...
  return (0, import_jsx_runtime23.jsx)(Container_default, {
    component: "main",
    maxWidth: "xs",
    children: (0, import_jsx_runtime23.jsxs)(Box_default, {
      ...
      children: [(branding == null ? void 0 : branding.logo) ?? (0, import_jsx_runtime23.jsx)(Avatar_default, {
        sx: {
          my: 1,
          mb: 2,
          bgcolor: "primary.main"
        },
        children: _LockOutlinedIcon || (_LockOutlinedIcon = (0, import_jsx_runtime23.jsx)(LockOutlined_default, {}))
      ...
      }), _Typography || (_Typography = (0, import_jsx_runtime23.jsx)(Typography_default, {
        variant: "body2",
        color: "textSecondary",
        gutterBottom: true,
        textAlign: "center",
        ...
        children: [(0, import_jsx_runtime23.jsxs)(Stack_default, {
          spacing: 1,
          children: [error && selectedProviderId !== "credentials" ? (0, import_jsx_runtime23.jsx)(Alert_default, {
            severity: "error",
            children: error
        ...
        }), credentialsProvider ? (0, import_jsx_runtime23.jsxs)(React21.Fragment, {
          children: [singleProvider ? null : (0, import_jsx_runtime23.jsx)(Divider_default, {
            ...
            children: [(slots == null ? void 0 : slots.emailField) ? (0, import_jsx_runtime23.jsx)(slots.emailField, {
              ...
              control: _Checkbox || (_Checkbox = (0, import_jsx_runtime23.jsx)(Checkbox_default, {
                value: "remember",
                color: "primary"
              })),
              label: "Remember me",
              ...
              ...slotProps == null ? void 0 : slotProps.submitButton,
              children: "Sign in"
            }), (slots == null ? void 0 : slots.forgotPasswordLink) || (slots == null ? void 0 : slots.signUpLink) ? (0, import_jsx_runtime23.jsxs)(Box_default, {
              sx: {
                display: "flex",
                justifyContent: "space-between",
                mt: 2
              },
              children: [(slots == null ? void 0 : slots.forgotPasswordLink) ? (0, import_jsx_runtime23.jsx)(slots.forgotPasswordLink, {
                ...slotProps == null ? void 0 : slotProps.forgotPasswordLink
              }) : null, (slots == null ? void 0 : slots.signUpLink) ? (0, import_jsx_runtime23.jsx)(slots.signUpLink, {
...
true ? SignInPage.propTypes = {
  ...
  providers: import_prop_types.default.arrayOf(import_prop_types.default.shape({
    id: import_prop_types.default.oneOf(["apple", "auth0", "cognito", "credentials", "discord", "facebook", "fusionauth", "github", "gitlab", "google", "instagram", "keycloak", "line", "linkedin", "microsoft-entra-id", "okta", "slack", "spotify", "tiktok", "twitch", "twitter"]).isRequired,
...
function PageContainerToolbar(props) {
  return (0, import_jsx_runtime24.jsx)(PageContainerToolbarRoot, {
    ...props
  });
}
...
function PageContainer(props) {
  ...
  const breadCrumbs = props.breadCrumbs ?? (activePage == null ? void 0 : activePage.breadCrumbs) ?? [];
  ...
  return (0, import_jsx_runtime25.jsx)(Container_default, {
    ...rest,
    children: (0, import_jsx_runtime25.jsxs)(Stack_default, {
      ...
      spacing: 2,
      children: [(0, import_jsx_runtime25.jsxs)(Stack_default, {
        children: [(0, import_jsx_runtime25.jsx)(Breadcrumbs_default, {
          "aria-label": "breadcrumb",
          children: breadCrumbs ? breadCrumbs.map((item, index) => {
            return index < breadCrumbs.length - 1 ? (0, import_jsx_runtime25.jsx)(Link_default, {
              component: Link,
              underline: "hover",
              color: "inherit",
              href: item.path,
              children: getItemTitle(item)
            }, item.path) : (0, import_jsx_runtime25.jsx)(Typography_default, {
              color: "text.primary",
              children: getItemTitle(item)
            }, item.path);
          }) : null
        }), (0, import_jsx_runtime25.jsxs)(PageContentHeader, {
          children: [title ? (0, import_jsx_runtime25.jsx)(Typography_default, {
            variant: "h4",
            children: title
          }) : null, (0, import_jsx_runtime25.jsx)(ToolbarComponent, {
            ...toolbarSlotProps
          })]
        })]
...
// node_modules/@toolpad/core/useSessionStorageState/useSessionStorageState.js
